...
class MoneyTest extends AbstractTestCase
{
    ...
    {
        return [
            [[['1.0', 'USD', new AutoContext()], ['3.50', 'USD'], ['4.00', 'USD']], ContextMismatchException::class],
            [[['5.00', 'USD'], ['3.50', 'USD'], ['4.00', 'USD']], 'USD 3.50'],
            [[['5.00', 'USD'], ['3.50', 'USD'], ['3.499', 'USD', new AutoContext()]], ContextMismatchException::class],
    ...
    public static function providerMax(): array
    {
        return [
            ...
            [[['1.3', 'USD', new AutoContext()], ['3.50', 'USD'], ['4.90', 'USD']], ContextMismatchException::class],
            [[['1.3', 'USD', new AutoContext()], ['7.119', 'USD', new AutoContext()], ['4.90', 'USD']], ContextMismatchException::class],
            [[['1.00', 'USD'], ['1.00', 'EUR']], CurrencyMismatchException::class],
        ];
    }
