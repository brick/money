...
interface ExchangeRateProvider
{
     ...
     * this library's conventions. Currency conversion through CurrencyConverter does not rely on providers for this
     * case, so this rule mainly matters when providers are used directly.
     *
     ...
     *                        The exchange rate must be strictly positive. Returning null is the correct response both
     *                        when the currency pair is not configured and when the requested dimensions are not
     *                        supported or fall outside the provider's scope. A null return allows a ChainProvider to
